module.exports = {
	...
	js:{
		file:'@cwd/dist/nodes-flowcontrol.mjs', // @cwd = directory where you start the Node.js
	...
	sf:{
		file: '@cwd/dist/nodes-flowcontrol.sf', // will have sf.css and sf.js
