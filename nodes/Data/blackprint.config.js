module.exports = {
	...
	name: "Data",
	description: "Data manipulation/compare/etc",
	...
	js:{
		file:'@cwd/dist/nodes-data.mjs', // @cwd = directory where you start the Node.js
	...
	sf:{
		file: '@cwd/dist/nodes-data.sf', // will have sf.css and sf.js
