module.exports = {
	...
	name: "Example",
	description: "Just an example nodes",
	...
	js:{
		file:'@cwd/dist/nodes-example.mjs', // @cwd = directory where you start the Node.js
	...
	sf:{
		file:'@cwd/dist/nodes-example.sf', // will have sf.css and sf.js
